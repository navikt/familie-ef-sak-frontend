...
export const initielleAvsnittInnhentingAvKarakterutskriftHovedperiode: AvsnittMedId[] = [
    {
        ...
        innhold:
            ...
            'Du må sende oss dokumentasjonen innen 21.07.2022.Dokumentere at du har gjennomført skoleåret\n' +
            ...
            '\t\n' +
            '\t•\tdu har barn med behov for særlig tilsyn, og dette hindrer deg i å jobbe, søke arbeid eller studere fulltid. Du må dokumentere dette med legeerklæring. \n' +
            '\t•\tdu eller barnet ditt har en sykdom som hindrer deg i å jobbe, søke arbeid eller studere mer enn 50 prosent. Du må dokumentere dette med legeerklæring. \n' +
            '\t•\tdu har gjort det du kan for å skaffe deg barnepass. Dette må du dokumentere med avslag på barnehageplass/SFO-plass, eventuelt dokumentasjon som viser at du står på venteliste. \n' +
            'Du kan lese mer om aktivitetsplikten på nav.no/overgangsstonad-enslig#aktivitet.\n' +
            '\t\n' +
...
export const initielleAvsnittInnhentingAvKarakterutskriftUtvidetPeriode: AvsnittMedId[] = [
    {
        ...
        innhold:
            ...
            'Har du spørsmål? Du finner informasjon som kan være nyttig for deg på nav.no/familie/alene-med-barn. Du kan også kontakte oss på nav.no/kontakt.\n',
        id: uuidv4(),
    },
];
