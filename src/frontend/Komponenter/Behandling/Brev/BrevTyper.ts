...
export const BrevtyperTilOverskrift: Record<FrittståendeBrevtype | FritekstBrevtype, string> = {
    ...
    OPPHØRT: 'Vi har stanset overgangsstønaden din',
    REVURDERT: 'Vi har vurdert overgangsstønaden din på nytt',
...
export const stønadstypeTilBrevtyper: Record<Stønadstype, FritekstBrevtype[]> = {
    OVERGANGSSTØNAD: [
        ...
        FritekstBrevtype.OPPHØRT,
        FritekstBrevtype.REVURDERT,
    ],
    BARNETILSYN: [
...
export const BrevtyperTilAvsnitt: Record<FrittståendeBrevtype | FritekstBrevtype, AvsnittMedId[]> =
    {
        ...
        OPPHØRT: initielleAvsnittVedtakAvslag,
        REVURDERT: initielleAvsnittVedtakInvilgelse,
