export enum EToast {
    ...
    REDIRECT_FAGSAK_PERSON_FEILET = 'REDIRECT_FAGSAK_PERSON_FEILET',
...
export const toastTilTekst: Record<EToast, string> = {
    ...
    REDIRECT_FAGSAK_PERSON_FEILET:
        'Kan ikke åpne behandlingsoversikten for denne personen. En uventet feil oppstod',
