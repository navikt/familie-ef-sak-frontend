...
const VedtakOgBeregning: FC<Props> = ({ behandlingId }) => {
    ...
    const [vedtaksresultatType, settVedtaksresultatType] = useState<
        EVilkårsresultatType
    >(EVilkårsresultatType.INNVILGE)

    const [vedtaksperiodeBegrunnelse, settVedtaksperiodeBegrunnelse] = useState<
        string
    >('')
    ...
    useEffect(() => {
        suksess &&
            history.push(`/behandling/${behandlingId}/utbetalingsoversikt`)
    }, [suksess])
    ...
    const vedtaksresultatSwitch = (
        vedtaksresultatType: EVilkårsresultatType
    ) => {
                ...
                return (
                    <>
                        ...
                        <Textarea
                            ...
                            label="Begrunnelse"
                        />
                        <Hovedknapp style={{ marginTop: '2rem' }}>
                            Lag blankett
                        </Hovedknapp>
                    </>
                )
        ...
        <>
            <StyledInntekt>
                ...
                <StyledTabell style={{ marginBottom: '2rem' }}>
                    ...
                    <Normaltekst>01.01.2021</Normaltekst>
                    <Søknadsgrunnlag />
                    <Normaltekst>Søknadsdato</Normaltekst>
                    <Normaltekst>01.01.2021</Normaltekst>
                </StyledTabell>
                <StyledSelect
                    ...
                    onChange={(e) => {
                        settVedtaksresultatType(
                            e.target.value as EVilkårsresultatType
                        )
                    }}
                >
                    <option value={EVilkårsresultatType.INNVILGE}>
                        Innvilge
                    </option>
                    <option value={EVilkårsresultatType.ANNULLER}>
                        ANNULLER
                    </option>
                </StyledSelect>
