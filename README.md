...
Secrets kan bli lagt inn automatisk dersom man kjører `sh hent-og-lagre-miljøvariabler.sh`. Scriptet krever at du har `jq` og er pålogget naisdevice og er logget inn på google `gcloud auth login`)
